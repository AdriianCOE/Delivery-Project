...
export const CLOUDINARY_IMAGE_VARIANTS = {
  ...
  storeLogoCoverLarge: 'f_auto,q_auto,c_fill,g_auto,w_240,h_240',
  storeBannerSmall: 'f_auto,q_auto:eco,c_fill,g_center,w_800,h_267',
  storeBannerMedium: 'f_auto,q_auto:eco,c_fill,g_center,w_1200,h_400',
  storeBanner: 'f_auto,q_auto:eco,c_fill,g_center,w_1440,h_480',
  storeBannerLarge: 'f_auto,q_auto:eco,c_fill,g_center,w_1600,h_533',
  storeBannerMobileSmall: 'f_auto,q_auto:eco,c_fill,g_center,w_400,h_267',
  storeBannerMobile: 'f_auto,q_auto:eco,c_fill,g_center,w_640,h_427',
  storeBannerMobileLarge: 'f_auto,q_auto:eco,c_fill,g_center,w_800,h_533',
  ogImage: 'f_auto,q_auto,c_fill,g_center,w_1200,h_630',
}
