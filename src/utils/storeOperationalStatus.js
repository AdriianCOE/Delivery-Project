...
export function getTemporaryPauseState(store = {}, options = {}) {
...
export function getStoreOperationalStatus(store = {}, options = {}) {
  if (!store) {
...
export function storeAllowsScheduledOrdersWhenClosed(store = {}) {
  return (
